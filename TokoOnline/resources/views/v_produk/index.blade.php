            ...
            <div class="product product-single"> 
                <div class="product-thumb"> 
                    ...
                    <a href="{{ route('produk.detail', $row->id) }}"> 
                        <button class="main-btn quick-view"><i class="fa fa-searchplus"></i> Product Details</button> 
                    </a> 
...
plus"></i></button> 
                       ...
                       <form action="{{ route('order.addToCart', $row->id) }}" method="post" style="display: inline-block;" title="Pesan Ke Aplikasi">
                                @csrf
                                <button type="submit" class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add</button>
                        </form>
                    </div> 
                </div> 
            </div> 
