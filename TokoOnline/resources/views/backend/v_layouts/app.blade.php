                ...
                <div class="navbar-header" data-logobg="skin5"> 
                    ...
                    <a class="navbar-brand" href="index.html"> 
                        ...
                        <b class="logo-icon p-l-10"> 
                            ...
                            <!-- Dark Logo icon --> 
                            <img src="{{asset('image/logo-text.png')}}" alt="homepage" class="light-logo" /> 
                        </b> 
                        <!--End Logo icon --> 
                        <!-- Logo text --> 
            ...
            <div class="scroll-sidebar"> 
                ...
                <nav class="sidebar-nav"> 
                    <ul id="sidebarnav" class="p-t-30"> 
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('backend.pesanan.index') }}" aria-expanded="false">
                            <i class="mdi mdi-account-multiple"></i><span class="hide-menu">Pesanan</span></a> 
                        </li>
